...
public class TestDBService {
    ...
    void testUpdateSomeExistingBook() throws UnsupportedEncodingException {
        ...
        assertOutput("""
                ...
                ------------------------\r
                Book{ id=30, name='The Four mushketeers', genre=Adventure, authors=Alexandre Dumas, comments=nice, meh, boring, dull, fine book}\r
                Book{ id=40, name='Le Docteur Servan', genre=Adventure, authors=Alexandre Dumas, comments=masterpiece, so much water, so short, creepy, i didnt understand that}\r
                ------------------------\r
                """);
    }
    ...
    void testInsertBook() throws UnsupportedEncodingException {
        dbService.addBook("SomeBook", null, 10L, Set.of(5L));
        dbService.showEntities(true, true, true);
        assertOutput("""
                The book Book{ id=41, name='SomeBook', genre=Adventure, authors=Alexandre Dumas, comments=} has been added\r
                ------------------------\r
                Book{ id=30, name='The Three Mushketeers', genre=Adventure, authors=Alexandre Dumas, comments=nice, meh, boring, dull, fine book}\r
                Book{ id=40, name='Le Docteur Servan', genre=Adventure, authors=Alexandre Dumas, comments=masterpiece, so much water, so short, creepy, i didnt understand that}\r
                Book{ id=41, name='SomeBook', genre=Adventure, authors=Alexandre Dumas, comments=}\r
                ------------------------\r
    ...
    void testDeleteAllBooks() throws UnsupportedEncodingException {
        dbService.showEntities(true, false, false);
        dbService.deleteEntity(List.of(30L, 40L), null, null, null);
        dbService.showEntities(true, false, false);
        assertOutput("""
                Book{ id=30, name='The Three Mushketeers', genre=Adventure, authors=Alexandre Dumas, comments=nice, meh, boring, dull, fine book}\r
                Book{ id=40, name='Le Docteur Servan', genre=Adventure, authors=Alexandre Dumas, comments=masterpiece, so much water, so short, creepy, i didnt understand that}\r
    ...
    void testInsertComment() throws UnsupportedEncodingException {
        dbService.showEntities(true, false, false);
        dbService.addComment(30L, "wow");
        dbService.showEntities(true, false, false);
        assertOutput("""
                Book{ id=30, name='The Three Mushketeers', genre=Adventure, authors=Alexandre Dumas, comments=nice, meh, boring, dull, fine book}\r
                Book{ id=40, name='Le Docteur Servan', genre=Adventure, authors=Alexandre Dumas, comments=masterpiece, so much water, so short, creepy, i didnt understand that}\r
                ------------------------\r
                Book{ id=30, name='The Three Mushketeers', genre=Adventure, authors=Alexandre Dumas, comments=nice, meh, boring, dull, fine book, wow}\r
                Book{ id=40, name='Le Docteur Servan', genre=Adventure, authors=Alexandre Dumas, comments=masterpiece, so much water, so short, creepy, i didnt understand that}\r     
                ------------------------\r
                """);
    }
